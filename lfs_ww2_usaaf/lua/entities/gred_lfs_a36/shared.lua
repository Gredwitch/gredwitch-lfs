...
ENT.MaxSecondaryAmmo 	= 1360 -- set to a positive number if you want to use weapons. set to -1 if you dont
...
ENT.BulletPos[5]		= Vector(178.888,12.2076,4.79268)
ENT.BulletPos[6]		= Vector(169.032,-12.1557,4.79268)

ENT.BulletPosAlt		= {}
ENT.BulletPosAlt[1]		= Vector(107.41,-88.8312,-18.0623)
ENT.BulletPosAlt[2]		= Vector(107.41,88.8312,-18.0623)
ENT.BulletPosAlt[3]		= Vector(107.41,-97.118,-18.0693)
ENT.BulletPosAlt[4]		= Vector(107.41,97.118,-18.0693)
...
ENT.BOMBS = {
	[1] = Vector(50.4627,-92.972,-19),
	[2] = Vector(50.4627,92.972,-19),
}
