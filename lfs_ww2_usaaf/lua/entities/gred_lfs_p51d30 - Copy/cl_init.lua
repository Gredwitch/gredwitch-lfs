...
function ENT:LFSHudPaint( X, Y, data ) -- driver only
	draw.SimpleText( "SLC", "LFS_FONT", 10, 135, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
	local t = self:GetCurSecondary()
	if t == 0 then t = "ROCKETS" elseif t == 1 then t = "BOMBS" elseif t == 999 then t = "NIL/GUNS" end
	draw.SimpleText( t, "LFS_FONT", 120, 135, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
end
...
function ENT:EngineActiveChanged( bActive )
	if bActive then
		self.snd.RPM0 = CreateSound(self,"P51D_RPM0")
		self.snd.RPM1 = CreateSound(self,"P51D_RPM1")
		self.snd.RPM2 = CreateSound(self,"P51D_RPM2")
		self.snd.RPM3 = CreateSound(self,"P51D_RPM3")
...
function ENT:AnimCabin()
	...
	self:ManipulateBonePosition(self.Bones.blister, Vector(0,0,-self.SMcOpen * 45))
